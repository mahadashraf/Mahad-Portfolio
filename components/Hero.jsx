...
const Hero = () => {
  return (
    ...
    <div className="flex max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left">
        ...
        <p className="subtitle max-w-[490px] mx-auto xl:mx-0">Ambitious computer scientist with a passion for technology, fast learner, adept at teamwork, excellent communication skills, and strong
organizational abilities. Eager to take on new challenges and contribute enthusiastically to any team.
        ...
        <Button variant="secondary" className='gap-x-2'><a href="https://aiapply.co/r/66760fdd9dbc1" target="_blank" rel="noopener noreferrer" download>
    Download Resume
  </a><Download size={18} /></Button>
        </div>
        {/* socials*/}
